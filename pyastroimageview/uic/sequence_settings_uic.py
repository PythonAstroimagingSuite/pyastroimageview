...
class Ui_SequenceSettingsUI(object):
    def setupUi(self, SequenceSettingsUI):
        ...
        SequenceSettingsUI.resize(499, 308)
        ...
        self.gridLayout.addWidget(self.sequence_start, 3, 5, 1, 1)
        ...
        self.gridLayout.addLayout(self.horizontalLayout, 14, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_number, 4, 5, 1, 1)
        ...
        self.sequence_frametype.addItem("")
        self.sequence_frametype.addItem("")
        self.gridLayout.addWidget(self.sequence_frametype, 5, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_status_label, 13, 3, 1, 4)
