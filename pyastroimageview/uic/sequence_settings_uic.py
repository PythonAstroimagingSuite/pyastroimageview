...
class Ui_SequenceSettingsUI(object):
    def setupUi(self, SequenceSettingsUI):
        ...
        SequenceSettingsUI.resize(483, 308)
        ...
        self.gridLayout.addWidget(self.sequence_select_targetdir, 12, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_status_label, 13, 3, 1, 5)
        ...
        self.gridLayout.addWidget(self.sequence_targetdir, 12, 2, 1, 5)
        ...
        self.gridLayout.addLayout(self.horizontalLayout, 14, 6, 1, 2)
