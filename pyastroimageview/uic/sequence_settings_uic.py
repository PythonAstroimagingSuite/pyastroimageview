...
class Ui_SequenceSettingsUI(object):
    def setupUi(self, SequenceSettingsUI):
        ...
        SequenceSettingsUI.resize(425, 301)
        ...
        self.gridLayout.addWidget(self.sequence_select_targetdir, 12, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_targetdir, 12, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.sequence_name, 0, 3, 1, 4)
        ...
        self.gridLayout.addWidget(self.sequence_number, 5, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.sequence_elements, 1, 3, 1, 3)
        ...
        self.gridLayout.addWidget(self.sequence_start, 4, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.sequence_elements_help, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_preview, 2, 3, 1, 2)
        ...
        self.sequence_frametype.addItem("")
        self.sequence_frametype.addItem("")
        self.gridLayout.addWidget(self.sequence_frametype, 7, 3, 2, 2)
        ...
        self.gridLayout.addLayout(self.gridLayout_2, 11, 3, 1, 1)
        ...
        self.sequence_binning.setMinimumSize(QtCore.QSize(48, 0))
        self.sequence_binning.setMaximumSize(QtCore.QSize(48, 16777215))
        ...
        self.gridLayout.addWidget(self.sequence_binning, 9, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.sequence_exposure, 6, 3, 1, 1)
        ...
        SequenceSettingsUI.setTabOrder(self.sequence_frametype, self.sequence_targetdir)
